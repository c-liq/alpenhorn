...
void polymul(mydouble *h, const mydouble *f, const mydouble *g)
{
	...
	t[7] =
		(f[0] * g[7] + f[1] * g[6] + f[2] * g[5] + f[3] * g[4] + f[4] * g[3] + f[5] * g[2] + f[6] * g[1] + f[7] * g[0]);
	t[8] = (f[1] * g[7] + f[7] * g[1]) * 6
		+ (f[0] * g[8] + f[2] * g[6] + f[3] * g[5] + f[4] * g[4] + f[5] * g[3] + f[6] * g[2] + f[8] * g[0]);
	t[9] = (f[1] * g[8] + f[2] * g[7] + f[7] * g[2] + f[8] * g[1]) * 6
		+ (f[0] * g[9] + f[3] * g[6] + f[4] * g[5] + f[5] * g[4] + f[6] * g[3] + f[9] * g[0]);
	t[10] = (f[1] * g[9] + f[2] * g[8] + f[3] * g[7] + f[7] * g[3] + f[8] * g[2] + f[9] * g[1]) * 6
		+ (f[0] * g[10] + f[4] * g[6] + f[5] * g[5] + f[6] * g[4] + f[10] * g[0]);
	t[11] = (f[1] * g[10] + f[2] * g[9] + f[3] * g[8] + f[4] * g[7] + f[7] * g[4] + f[8] * g[3] + f[9] * g[2]
		+ f[10] * g[1]) * 6 + (f[0] * g[11] + f[5] * g[6] + f[6] * g[5] + f[11] * g[0]);
	t[12] =
		(f[1] * g[11] + f[2] * g[10] + f[3] * g[9] + f[4] * g[8] + f[5] * g[7] + f[7] * g[5] + f[8] * g[4] + f[9] * g[3]
			+ f[10] * g[2] + f[11] * g[1]) * 6 + f[6] * g[6];
	t[13] =
		(f[2] * g[11] + f[3] * g[10] + f[4] * g[9] + f[5] * g[8] + f[6] * g[7] + f[7] * g[6] + f[8] * g[5] + f[9] * g[4]
			+ f[10] * g[3] + f[11] * g[2]);
	t[14] = f[7] * g[7] * 6
		+ (f[3] * g[11] + f[4] * g[10] + f[5] * g[9] + f[6] * g[8] + f[8] * g[6] + f[9] * g[5] + f[10] * g[4]
			+ f[11] * g[3]);
	t[15] = (f[7] * g[8] + f[8] * g[7]) * 6
		+ (f[4] * g[11] + f[5] * g[10] + f[6] * g[9] + f[9] * g[6] + f[10] * g[5] + f[11] * g[4]);
