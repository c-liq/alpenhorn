...
class CheckDouble
{
	...
	CheckDouble(
	const double a,
	const unsigned long long int mmax)
	{
		v = a;
		this->mmax = mmax;
	}
	...
	int operator==(const CheckDouble
	&a)const
	{
		return v == a.v;
	}
	...
	*/
	...
	friend
	long long ftoll(const CheckDouble
	&arg)
	{
	...
	friend
	double todouble(const CheckDouble
	&arg)
	{
		return arg.v;
	}
