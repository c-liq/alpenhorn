...
int mix_entry_process_msg(void *client, net_header *header, connection *conn, byte_buffer_s *buf);
int client_net_pkg_auth(client_s *cn);
int client_net_process_pkg(void *c, connection *conn, net_header *header, byte_buffer_s *buf);
int mix_last_process_msg(void *client, net_header *header, connection *conn, byte_buffer_s *buf);
