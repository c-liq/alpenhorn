...
#define pkg_enc_auth_res_BYTES (pkg_auth_res_BYTES + crypto_secretbox_MACBYTES + crypto_secretbox_NONCEBYTES)

#define pkg_broadcast_msg_BYTES (bn256_ibe_pkg_pk_BYTES + crypto_box_PKBYTES)

#define pkg_sig_message_BYTES (user_id_BYTES + crypto_sign_PUBLICKEYBYTES + round_BYTES)

#define client_sigmsg_BYTES (round_BYTES + user_id_BYTES + crypto_box_PUBLICKEYBYTES)
